...
const futureScreens: CompassScreen[] = [
  ...
  },
  {
    ...
    placeholder: "Write, sketch and go wild with ideas!",
    isRequired: true,
  },
  {
    id: "future-work",
...
const perfectDayScreens: CompassScreen[] = [
  ...
  },
  {
    ...
    inputs: [
      { key: "thought1", placeholder: "First thought" },
      { key: "thought2", placeholder: "Second thought" },
      { key: "thought3", placeholder: "Third thought" },
    ],
    isRequired: true,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { key: "grateful1", placeholder: "First thing" },
      { key: "grateful2", placeholder: "Second thing" },
      { key: "grateful3", placeholder: "Third thing" },
    ],
    isRequired: true,
    backgroundVariant: "night",
  },
...
const lightingScreens: CompassScreen[] = [
  ...
  },
  {
    ...
    inputs: [
      { key: "env1", placeholder: "Environment improvement 1" },
      { key: "env2", placeholder: "Environment improvement 2" },
      { key: "env3", placeholder: "Environment improvement 3" },
    ],
    isRequired: true,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { key: "person1", placeholder: "Person 1" },
      { key: "person2", placeholder: "Person 2" },
      { key: "person3", placeholder: "Person 3" },
    ],
    isRequired: true,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { key: "thing1", placeholder: "For loved ones 1" },
      { key: "thing2", placeholder: "For loved ones 2" },
      { key: "thing3", placeholder: "For loved ones 3" },
    ],
    isRequired: true,
  },
  {
